...
add='C:/Users/ashim/AppData/Local/Programs/Python/Python36/myscript/Logs/'
file_path='C:/Users/ashim/AppData/Local/Programs/Python/Python36/myscript/'
       ...
       #NOW CHECK IF NAMESHEET ALREADY EXIST
        try:
            if not namesheet in wb.sheetnames:            
                ...
                logger.error("Images loaded and background color set\n")

            #NOW READ DATA FILE
                logger.error("Reading Data from text file\n")
            ...
            #get the total number of files for each reciver for a type 33 or 07
                ...
                logger.error("************************************************************************************\n")
                logger.error("Data files read, no of file to be written to excell\n")
                logger.error("File_07_111: "+str(file_07_111)+"\n")
                logger.error("File_07_108: "+str(file_07_108)+"\n")
                logger.error("File_33_111: "+str(file_33_111)+"\n")
                logger.error("File_33_108: "+str(file_33_108)+"\n")
            ...
            #Read and process first file
                ...
                #substring to get filetype and receiverid
                        ...
                        if(f_t=='07' and rId=='111'):
                            logger.error("Start processing File 07_111\n")
                            ...
                            logger.error('File 07_111 processed\n')
                            logger.error('=======================================================================\n')                        
                        
                #now fill the data for file 07 from 108
                        elif(f_t=='07' and rId=='108'):
                            logger.error('Start processing File 07_108\n')
                            #call function
                            (last_index_07108,next_index_33111,next_index_33108)=myFunctions.startFillingFrom(file_07_111,file_07_108,file_33_111,file_33_108)
                            ...
                            logger.error("File 07_108 processed\n")
                            logger.error("=======================================================================\n")
                ...
                #now fill the data for file 33 from 111
                            ...
                            logger.error("Start processing File 33_111\n")
                            ...
                            logger.error("File 33_111 processed\n")
                            logger.error("=======================================================================\n")
                            
                                      
                #now fill the data for file 33 from 108
                        elif(f_t=='33' and rId=='108'):
                            logger.error("Start processing File 33_108\n")
                            total_index=0
                            (last_index_07108,next_index_33111,next_index_33108)=myFunctions.startFillingFrom(file_07_111,file_07_108,file_33_111,file_33_108)
                            ...
                            if(c_33_108==0):
                                ...
                                logger.error("ERROR!!! Number of files to be processed more than 3, System cannot process the file,check manually\n")
                            logger.error("File 33_108 processed\n")
                            
                            
                    except Exception as err:
                            logger.exception(str(err))
                logger.error("=======================================================================\n")             
                logger.error("This section is where formula is being processed\n")       
                ...
                logger.error("All total has been calculated and filled in the cells\n")
                logger.error("Now processing LPN fee, Letter1 fee and Letter 2 fee\n")
                    ...
                    if(file_33_108!=0):
                        ...
                        if(temp_count==2):
                            ...
                            if(temp_count==1):
                                ...
                                indx+=1
                                admin_next=indx
                logger.error("Data inserted into file\n")            
            #save file
                wb.save(file_path+'File/'+m+'/'+m+'_'+mYYYY+'.xlsx')
                logger.error("Excell file Created and saved.logger file Created as well\n")
                logger.error("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
                logger.error("End of Process")
            else:
                raise FileExistsError("Sheet already exist with current date as name,please check the excel file\n")
                log.error("Sheet already exist with current date as name,please check the excel file")
